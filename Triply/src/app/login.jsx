  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: "#FFFFFF" }}>
      <View style={loginStyle.container}>
        ...
        <Text style={[loginStyle.title, loginStyle.fonte]}>
          Entrar
        </Text>
        ...
        <View style={loginStyle.formContainer}>
          ...
          >
            <Text
              style={[loginStyle.esqueceuSenha, loginStyle.fonte]}
            >
              Esqueceu a senha?
            </Text>
          </TouchableOpacity>
          ...
          <View style={loginStyle.dividerContainer}>
            ...
            <Text
              style={[loginStyle.dividerText, loginStyle.fonte]}
            >
              OU
            </Text>
          ...
          <Text style={[loginStyle.signupText, loginStyle.fonte]}>
            ...
            <Text
              style={[loginStyle.signupLink, loginStyle.fonte]}
